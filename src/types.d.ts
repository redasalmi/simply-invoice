...
import type { createTax, deleteTax, getTax, getTaxes, updateTax } from './main/services/taxes'
import type { getUserSettings, updateUserSetting } from './main/services/user-settings'
...
export type AddressCreateFlatErrors = v.FlatErrors<typeof Validation.addressCreateSchema>
export type AddressUpdateFlatErrors = v.FlatErrors<typeof Validation.addressUpdateSchema>

// company types
export type Company = typeof companiesTable.$inferSelect
export type CreateCompanyInput = typeof companiesTable.$inferInsert
export type CreateCompanyWithAddressInput = Omit<CreateCompanyInput, 'addressId'>
export interface UpdateCompanyWithAddressInput extends CreateCompanyWithAddressInput {
  companyId: string
}

export type CompanyCreateWithAddressResult = ReturnType<typeof createCompanyWithAddress>
export type CompanyUpdateWithAddressResult = ReturnType<typeof updateCompanyWithAddress>
...
>
export type CompanyDeleteFlatErrors = v.FlatErrors<typeof Validation.companyDeleteSchema>

// customer types
export type Customer = typeof customersTable.$inferSelect
export type CreateCustomerInput = typeof customersTable.$inferInsert
export type CreateCustomerWithAddressInput = Omit<CreateCustomerInput, 'addressId'>
export interface UpdateCustomerWithAddressInput extends CreateCustomerWithAddressInput {
  customerId: string
}

export type CustomerCreateWithAddressResult = ReturnType<typeof createCustomerWithAddress>
export type CustomerUpdateWithAddressResult = ReturnType<typeof updateCustomerWithAddress>
...
>
export type CustomerDeleteFlatErrors = v.FlatErrors<typeof Validation.customerDeleteSchema>
...
export type ServiceCreateFlatErrors = v.FlatErrors<typeof Validation.serviceCreateSchema>
export type ServiceUpdateFlatErrors = v.FlatErrors<typeof Validation.serviceUpdateSchema>
export type ServiceDeleteFlatErrors = v.FlatErrors<typeof Validation.serviceDeleteSchema>
...
export type TaxCreateFlatErrors = v.FlatErrors<typeof Validation.taxCreateSchema>
export type TaxUpdateFlatErrors = v.FlatErrors<typeof Validation.taxUpdateSchema>
export type TaxDeleteFlatErrors = v.FlatErrors<typeof Validation.taxDeleteSchema>
...
export type UserSettingsUpdateFlatErrors = v.FlatErrors<typeof Validation.userSettingUpdateSchema>
