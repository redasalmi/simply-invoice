...
export function CustomerDeleteRoute() {
  ...
  if (!customer) {
    return (
      <Dialog.Root closeDialog={closeAlert} open role="alertdialog">
        ...
        <Dialog.Description>
          Sorry but no customer with the ID: {params.customerId} was not found. Click the continue
          button to navigate back to your customers list.
        </Dialog.Description>
  ...
  return (
    <Dialog.Root closeDialog={closeAlert} open role="alertdialog">
      ...
      <Dialog.Description>
        This action cannot be undone. This will permanently delete the {customer.name} customer.
      </Dialog.Description>
