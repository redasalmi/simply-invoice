...
import { TaxCreateRoute, taxCreateAction } from '~/renderer/routes/taxes/tax-create'
import {
  TaxDeleteRoute,
  taxDeleteAction,
  taxDeleteLoader,
} from '~/renderer/routes/taxes/tax-delete'
import { TaxDetailRoute, taxDetailLoader } from '~/renderer/routes/taxes/tax-detail'
import {
  TaxUpdateRoute,
  taxUpdateAction,
  taxUpdateLoader,
} from '~/renderer/routes/taxes/tax-update'
import { TaxesListRoute, taxesListLoader } from '~/renderer/routes/taxes/taxes-list'
