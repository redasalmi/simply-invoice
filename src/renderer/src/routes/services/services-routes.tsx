...
import { ServiceCreateRoute, serviceCreateAction } from '~/renderer/routes/services/service-create'
import {
  ServiceDeleteRoute,
  serviceDeleteAction,
  serviceDeleteLoader,
} from '~/renderer/routes/services/service-delete'
import { ServiceDetailRoute, serviceDetailLoader } from '~/renderer/routes/services/service-detail'
import {
  ServiceUpdateRoute,
  serviceUpdateAction,
  serviceUpdateLoader,
} from '~/renderer/routes/services/service-update'
import { ServicesListRoute, servicesListLoader } from '~/renderer/routes/services/services-list'
