...
export async function servicesListLoader({ request, context }: LoaderFunctionArgs) {
  ...
  return {
    services: await window.api.db.services.get(cursor, paginationType, itemsPerPage),
  }
}
