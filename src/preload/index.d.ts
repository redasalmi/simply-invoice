    ...
    api: {
      db: {
        companies: {
          ...
          delete: (
            companyId: string
          ) => Types.CompanyDeleteResult | { errors: Types.CompanyDeleteFlatErrors }
        }
        customers: {
          createWithAddress: (
          ...
          delete: (
            customerId: string
          ) => Types.CustomerDeleteResult | { errors: Types.CustomerDeleteFlatErrors }
        }
        services: {
          create: (
            service: Types.CreateServiceInput
          ) => Types.ServiceCreateResult | { errors: Types.ServiceCreateFlatErrors }
          get: (
            cursor: string | null,
            paginationType: Types.PaginationType | null,
            itemsPerPage: number
          ...
          ) => Types.ServiceUpdateResult | { errors: Types.ServiceUpdateFlatErrors }
          delete: (
            serviceId: string
          ) => Types.ServiceDeleteResult | { errors: Types.ServiceDeleteFlatErrors }
        }
        taxes: {
          create: (
          ...
          delete: (taxId: string) => Types.TaxDeleteResult | { errors: Types.TaxDeleteFlatErrors }
        }
        userSettings: {
          get: () => Types.UserSettingsGetResult
          update: (
            userSetting: Types.UpdateUserSettingInput
          ) => Types.UserSettingsUpdateResult | { errors: Types.UserSettingsUpdateFlatErrors }
        }
      }
    }
  }
