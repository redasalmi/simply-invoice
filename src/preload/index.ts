...
const api = {
  db: {
    companies: {
      createWithAddress: (company: CreateCompanyWithAddressInput, address: CreateAddressInput) => {
        return ipcRenderer.invoke('create-company-with-address', company, address)
      },
      updateWithAddress: (company: UpdateCompanyWithAddressInput, address: UpdateAddressInput) => {
        return ipcRenderer.invoke('update-company-with-address', company, address)
      },
      get: (cursor: string | null, paginationType: PaginationType | null, itemsPerPage: number) => {
        return ipcRenderer.invoke('get-companies', cursor, paginationType, itemsPerPage)
      },
    ...
    customers: {
      createWithAddress: (
        ...
        return ipcRenderer.invoke('create-customer-with-address', customer, address)
      },
      updateWithAddress: (
        customer: UpdateCustomerWithAddressInput,
        address: UpdateAddressInput
      ) => {
        return ipcRenderer.invoke('update-customer-with-address', customer, address)
      },
      get: (cursor: string | null, paginationType: PaginationType | null, itemsPerPage: number) => {
        return ipcRenderer.invoke('get-customers', cursor, paginationType, itemsPerPage)
      },
    ...
    services: {
      ...
      get: (cursor: string | null, paginationType: PaginationType | null, itemsPerPage: number) => {
        return ipcRenderer.invoke('get-services', cursor, paginationType, itemsPerPage)
      },
    ...
    taxes: {
      ...
      get: (cursor: string | null, paginationType: PaginationType | null, itemsPerPage: number) => {
        return ipcRenderer.invoke('get-taxes', cursor, paginationType, itemsPerPage)
      },
